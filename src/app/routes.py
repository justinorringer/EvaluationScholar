...
@routes.route('/api/authors', methods=['GET'])
def get_authors():
...
@routes.route('/api/authors/<int:id>', methods=['GET'])
def get_author(id):
...
@routes.route('/api/authors', methods=['POST'])
def create_author():
...
@routes.route('/api/authors/<int:id>', methods=['PUT'])
...
@routes.route('/api/authors/<int:id>', methods=['DELETE'])
...
@routes.route('/api/authors/<int:author_id>/papers/<int:paper_id>', methods=['PUT'])
...
@routes.route('/api/authors/<int:author_id>/papers/<int:paper_id>', methods=['DELETE'])
...
@routes.route('/api/authors/<int:author_id>/papers', methods=['GET'])
